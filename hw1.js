...
const Product = class Product {
    ...
    static halfOff = (products) => {
        return products.map(element => new Product("'"+ element.name + "," +parseFloat(element.price) * .5 + "," +element.availability + "'"));
        // let newarr = []
        // let productsarr = []
        // products.map(element => newarr.push("'"+ element.name + "," + parseFloat(element.price) * .5 + "," + element.availability + "'"))

        // newarr.forEach(element => productsarr.push(new Product(element)))
    ...
    static printProducts = (products) => {
        ...
        products.forEach(element => {
            ...
            console.log("Product: " + element.name + ", " + "Cost: $" + element.price.toFixed(2) + ", " + "Availability: " + availability )
